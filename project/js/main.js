...
// это вообще  разумно.
// А еще возник эффект, когда значние по умолчанию перезаписало все
// цены в products - причем даже до того, как эта строка появилась.
// Объяснение не смог придумать.
//
